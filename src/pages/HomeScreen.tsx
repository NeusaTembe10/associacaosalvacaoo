...
export default function HomeScreen() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 pb-8">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-primary-900 to-primary-800 text-black px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-3xl sm:text-4xl font-bold mb-2">Bem-vindo! 🙏</h1>
          <p className="text-primary-200 text-base sm:text-lg">
            Gerencie as atividades da sua comunidade de fé
          </p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-primary-500">
            ...
            <h3 className="text-3xl font-bold text-slate-900">2,459</h3>
            <p className="text-xs text-green-600 mt-2">↑ 12% este mês</p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
            <p className="text-slate-600 text-sm font-medium mb-1">Cultos</p>
            <h3 className="text-3xl font-bold text-slate-900">48</h3>
            <p className="text-xs text-blue-600 mt-2">Este mês</p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
            <p className="text-slate-600 text-sm font-medium mb-1">
              Visitantes
            </p>
            <h3 className="text-3xl font-bold text-slate-900">127</h3>
            <p className="text-xs text-purple-600 mt-2">↑ 8% esta semana</p>
          </div>
        </div>
      </div>
